...
* The original package name 'com.springphonewebapp.spring-phonebook-app' is invalid and this project uses 'com.springphonewebapp.springphonebookapp' instead.
